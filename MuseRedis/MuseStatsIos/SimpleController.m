...
- (void)receiveMuseDataPacket:(IXNMuseDataPacket *)packet
    ...
    if (packet.packetType == IXNMuseDataPacketTypeAlphaAbsolute ||
        ...
        [appDelegate.waves addObject:[NSNumber numberWithDouble:[packet.values[IXNEegEEG1] doubleValue]]];
        [appDelegate.waves addObject:[NSNumber numberWithDouble:[packet.values[IXNEegEEG2] doubleValue]]];
        [appDelegate.waves addObject:[NSNumber numberWithDouble:[packet.values[IXNEegEEG3] doubleValue]]];
        [appDelegate.waves addObject:[NSNumber numberWithDouble:[packet.values[IXNEegEEG4] doubleValue]]];
        appDelegate.scanning = YES;
    }
}
